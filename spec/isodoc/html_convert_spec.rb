...
RSpec.describe IsoDoc::MPFA do
  ...
  it "processes pre" do
    ...
    expect(xmlpp(IsoDoc::MPFA::HtmlConvert.new({})
      ...
      <body lang="EN-US" link="blue" vlink="#954F72">
        ...
        <div class="WordSection3">
          ...
          <div id="M">
            ...
            <div id="N">
              <h2>2.1.<span style="mso-tab-count:1">  </span>Introduction</h2>
            </div>
            <div id="O">
              <h2>2.2.<span style="mso-tab-count:1">  </span>Clause 4.2</h2>
            </div>
          </div>
          <p>
            <br clear="all" style="mso-special-character:line-break;page-break-before:always"/>
          ...
          <div class="Section3" id="P">
            ...
            <div>
              <h2 class="Section3">A.2.<span style="mso-tab-count:1">  </span>Normative References</h2>
            </div>
            <div id="S">
              <h2>A.3.<span style="mso-tab-count:1">  </span>Bibliography</h2>
              <div>
                <h3 class="Section3">A.3.1.<span style="mso-tab-count:1">  </span>Bibliography Subsection</h3>
              </div>
            </div>
          </div>
        </div>
  ...
  it "processes containers" do
    ...
    expect(xmlpp(IsoDoc::MPFA::WordConvert.new({})
      .convert("test", presxml, true)
      .gsub(%r{^.*<body}m, "<body")
      .gsub(%r{</body>.*}m, "</body>"))).to be_equivalent_to xmlpp(word)
  end
